      ...
      <section className="grid grid-cols-2 h-[75vh] bg-neutral-50 about">
        ...
        <div className="place-self-center max-w-xl">
          ...
          <p className="text-2xl text-gray-500 font-sans font-light leading-2">
            ...
            <br />
            <br />
            Continue scrolling to see Jigsaw's <a href="/" className="font-sans underline text-green-500 hover:text-gray-900">features</a>.
          </p>
        </div>
      </section>

      <section className="text-center pt-40">
        <h1 className="text-5xl font-semibold"><span className="">Features to streamline productivity</span></h1>
      </section>
