...
export default function AccountSettings() {
  ...
  return (
    <>
      <div>
        <ul className="flex gap-6 py-6 px-10 border-b cursor-pointer bg-white">
          <li>Account</li>
          <li>Notifications & Security</li>
          <li>Billing</li>
          <li>Appearance</li>
        </ul>
      </div>
      ...
      <section className="flex px-10 gap-20 py-20 border-b">
        <div className="w-1/3">
          ...
          <p className="font-light text-gray-500">
            ...
            account will be deleted permanently and your subscription will be
            canceled.
          </p>
        </div>
        <div className="w-2/3">
