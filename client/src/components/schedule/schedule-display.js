    ...
    <>
      ...
      {hoursExpanded && (
        <ExpandableContainer>
          <TimeInput
            update={updateHours}
            wake={convertTime(wake, "utc")}
            sleep={convertTime(sleep, "utc")}
            close={setHoursExpanded}
          />
        </ExpandableContainer>
      )}

      <div>{renderSchedule()}</div>
      <ScheduleButton onClick={() => sortSchedule(setSchedule, wake, sleep)}>
        <ScheduleText>Generate Schedule</ScheduleText>
      </ScheduleButton>
      <ScheduleButton onClick={() => resortSchedule(setSchedule, wake, sleep)}>
        <ScheduleText>Resort Schedule</ScheduleText>
      </ScheduleButton>
